...
<%
	...
	try {
		...
		String query = "select QNAtitle, QNAwriter, QNAcontent from qnaboard where QNAno='"+no+"'";
...
<div class="row">
		...
		<div class="col-8">
			...
			<br><br>
			<form name="QNAw" id= "QNAw" action="QNAmodifyOK.jsp?no=<%=no %>" method = "post" accept-charset="UTF-8" enctype="multipart/form-data">
				<div class="row">
					<input style="width:99%; height:30px" type="text" name="name" class="form-control" id="QNAname" value="<%= name %>" readonly>
				</div>
				<br>
