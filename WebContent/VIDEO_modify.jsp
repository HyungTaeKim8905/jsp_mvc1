...
<!-- 이미지첨부 파일선택 버튼 감추기 적용 끝ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ-->
	...
	<%	// 로그인 한 사람의 name을 가져오기 위해 세션영역에 저장되어있는 id를 가져옴
		...
		if(SessionID == null)	{
			%> <script> alert("로그인 후 이용하자!"); location.href="SignIn.jsp"; </script> <%
		}
		...
		try {
			sql = "select name,title,note,filename,filerealname,videopath from board where no='" + no + "'";
			dbm.DBOpen();
			dbm.OpenQuery(sql);
	...
	<form id="frm" name="frm" action="VIDEO_modifyok.jsp?no=<%= no %>" method="post" enctype="multipart/form-data">
...
<!-- ㅡㅡㅡㅡㅡ 제목 작성 영역 시작ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ--> 
			<tr>
				<td>
					<input style="width:99%; height:30px" type="text" name="title" class="form-control" id="VIDEO_title" value="<%= title %>">
				</td>
			</tr>
<!-- ㅡㅡㅡㅡㅡ 제목 작성 영역 끝ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ-->
...
<!-- ㅡㅡㅡㅡㅡ 본문 작성 영역 시작ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ-->
			<tr>
				<td>
					<textarea class="summernote" id="summernote" name="note"><%= note %></textarea>
				</td>
			</tr>
...
<!-- ㅡㅡㅡㅡㅡ 파일첨부영역 시작ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ-->
			...
			<tr>					
				<td>	<!--  동영상 주소 -->
					<textarea style="width:99%; height:30px" name="videopath" class="form-control" id="VIDEO_add"><%= videopath %></textarea>
				</td>
			</tr>
